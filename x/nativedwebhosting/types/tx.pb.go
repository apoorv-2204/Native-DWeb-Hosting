...
func (m *MsgStorage) Reset()         { *m = MsgStorage{} }
func (m *MsgStorage) String() string { return proto.CompactTextString(m) }
func (*MsgStorage) ProtoMessage()    {}
func (*MsgStorage) Descriptor() ([]byte, []int) {
	return fileDescriptor_b00cb2cbfc507cd1, []int{2}
}
func (m *MsgStorage) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MsgStorage) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MsgStorage.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MsgStorage) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MsgStorage.Merge(m, src)
}
func (m *MsgStorage) XXX_Size() int {
	return m.Size()
}
func (m *MsgStorage) XXX_DiscardUnknown() {
	xxx_messageInfo_MsgStorage.DiscardUnknown(m)
}

var xxx_messageInfo_MsgStorage proto.InternalMessageInfo

func (m *MsgStorage) GetCreator() string {
	if m != nil {
		return m.Creator
	}
	return ""
...
func (m *MsgStorage) GetVersion() string {
	if m != nil {
		return m.Version
	}
	return ""
...
func (*MsgStorageResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_b00cb2cbfc507cd1, []int{3}
}
...
func init() {
	...
	proto.RegisterType((*MsgStorage)(nil), "nativedwebhosting.nativedwebhosting.MsgStorage")
	proto.RegisterType((*MsgStorageResponse)(nil), "nativedwebhosting.nativedwebhosting.MsgStorageResponse")
}
...
var fileDescriptor_b00cb2cbfc507cd1 = []byte{
	...
	0xb5, 0xb8, 0x20, 0x3f, 0xaf, 0x38, 0x55, 0xc9, 0x81, 0x8b, 0xcb, 0xb7, 0x38, 0x3d, 0xb8, 0x24,
	0xbf, 0x28, 0x31, 0x3d, 0x95, 0x1c, 0x07, 0x28, 0x89, 0x70, 0x09, 0x21, 0x4c, 0x80, 0x99, 0x6b,
	0xf4, 0x9f, 0x91, 0x8b, 0xd9, 0xb7, 0x38, 0x5d, 0xa8, 0x89, 0x91, 0x8b, 0x07, 0xc5, 0x8f, 0x26,
	0x7a, 0x44, 0x04, 0x8e, 0x1e, 0x9a, 0x73, 0xa5, 0x6c, 0xc8, 0xd1, 0x05, 0x73, 0x8c, 0x50, 0x31,
	0x17, 0x3b, 0xcc, 0x87, 0xfa, 0xc4, 0x1a, 0x04, 0xd5, 0x20, 0x65, 0x4e, 0xa2, 0x06, 0x98, 0xa5,
	...
	0x92, 0x51, 0x9a, 0xa4, 0x97, 0x9c, 0x9f, 0xab, 0x9f, 0x58, 0x90, 0x9f, 0x5f, 0x54, 0xa6, 0x6b,
	0x64, 0x64, 0x60, 0xa2, 0xef, 0x07, 0x36, 0x56, 0xd7, 0x25, 0x3c, 0x35, 0x49, 0xd7, 0x03, 0x9a,
	0xa6, 0x2a, 0xb0, 0xa5, 0xb3, 0xca, 0x82, 0xd4, 0xe2, 0x24, 0x36, 0x70, 0x5a, 0x33, 0x06, 0x04,
	0x00, 0x00, 0xff, 0xff, 0x52, 0x7a, 0x9a, 0x0b, 0x9b, 0x02, 0x00, 0x00,
}
...
type MsgClient interface {
	...
	Storage(ctx context.Context, in *MsgStorage, opts ...grpc.CallOption) (*MsgStorageResponse, error)
}
...
func (c *msgClient) Storage(ctx context.Context, in *MsgStorage, opts ...grpc.CallOption) (*MsgStorageResponse, error) {
	out := new(MsgStorageResponse)
	err := c.cc.Invoke(ctx, "/nativedwebhosting.nativedwebhosting.Msg/Storage", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MsgServer interface {
	...
	Storage(context.Context, *MsgStorage) (*MsgStorageResponse, error)
}
...
func (*UnimplementedMsgServer) Storage(ctx context.Context, req *MsgStorage) (*MsgStorageResponse, error) {
...
func _Msg_Storage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MsgStorage)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MsgServer).Storage(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/nativedwebhosting.nativedwebhosting.Msg/Storage",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MsgServer).Storage(ctx, req.(*MsgStorage))
	}
	return interceptor(ctx, in, info, handler)
}
...
func (m *MsgStorage) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MsgStorage) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MsgStorage) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *MsgStorage) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MsgStorage: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MsgStorage: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
